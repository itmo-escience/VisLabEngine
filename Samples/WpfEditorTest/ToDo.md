...
- [x] Мультивыделение фреймов
  ...
  - [ ] Перизмерение масштабное с сохранением пропорций каждого фрейма (как в PowerPoint)
...
- [ ] Перенести switch по дрэгам во FrameSelectionPanel и сделать в виде словаря или поименовать константы + сделать соответствующие поля приватными
- [ ] Перевести мультивыделение с индивидуальных панелек на групповую панельку 
