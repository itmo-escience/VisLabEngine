...
- [ ] Добавить возможность зума (ZoomIn/ZoomOut) для pixel perfect настройки
...
- [ ] Программа закрывается после отмены сохранения измененной сцены
- [ ] Не выделяется текущий добавляемый шаблон
- [ ] Подумать над выделением нескольких фреймов при случае, когда через shift дополнительно выделяется дочерний элемент одно из ранее выбранных фреймов