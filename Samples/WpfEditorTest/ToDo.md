...
- [ ] Добавить логику многократного клика по элементам (для контейнеров) как в Figma
- [ ] Выделение рамкой захватывает элементы при пересечении, а не при полном нахождении элементов в ней
- [ ] Элементы при бросании на компонент делать детьми только при начале перетаскивания с нажатой клавишей "?" (в противном случае элемент остается в том же родителе)
- [ ] Выделение рамкой детей сделать на "Ctrl"

- [ ] BoundingBox не отображает глобальные координаты
- [ ] Избавиться от назначения свойств компоненту через компоненты WPF (менять нужно напрямую как через окно свойств компонента)
- [ ] Сделать Reparenting при перемещении мышью
- [ ] VerticalBox иногда схлапывает своих детей при назначении
