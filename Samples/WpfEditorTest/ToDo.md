...
- [ ] Исправить индикатор "грязи" при выполнении команд через Undo/Redo
...
- [ ] Сброс каретки при изменении текстовых полей (именование элементов и изменение параметров)
- [ ] Дублирование в дереве элементов первого непосредственно брошенного на контейнер элемента (вводит в заблуждение)
- [ ] Нет прокрутки дерева элементов при помощи мыши
- [ ] Начинает тормозить при большом количестве элементов на экране (Edit-режим отрисовки границ всех компонентов?)
- [ ] Отловить падение в TreeView
- [ ] Невозможность выделить рамкой дочерние элементы контейнера (выбирается и мгновенно перетаскивается контейнер) (?)
