...
namespace Fusion.Drivers.Input {
	...
	internal class InputDevice : DisposableBase {
        ...
        public delegate void MouseDownEventHandler(object sender, KeyEventArgs k, MouseMoveEventArgs m);
        public delegate void MouseUpEventHandler(object sender, KeyEventArgs k, MouseMoveEventArgs m);
        public delegate void MousePressEventHandler(object sender, KeyEventArgs k, MouseMoveEventArgs m);
        ...
        public event Action<TouchEventArgs> TouchHold;
        ...
        public void NotifyTouchHold(TouchEventArgs args)
        {
            if (TouchHold != null)
            {
                TouchHold(args);
