...
namespace Fusion.Engine.Graphics.GIS
{
	public class HeatMapLayer : PolyGisLayer
	{
	    ...
	    public SamplerState TextureSampling = SamplerState.LinearClamp, MapSampling = SamplerState.AnisotropicClamp;
	    public bool IsNeedBlur = true;
