...
{
	public class DarkV9 : BaseMapBoxMap
	{
		public override string Name
		{
			get { return "DarkMapV9"; }
		}
		...
		public DarkV9(Game game) : base(game)
		{
			TileSize = 256;
			AcessToken = "pk.eyJ1Ijoia2FwYzNkIiwiYSI6ImNpbGpodG82czAwMmlubmtxamdsOHF0a3AifQ.xCbMUsy_a_0A9cd4GvjXKQ";
			UrlFormat = "https://api.mapbox.com/styles/v1/mapbox/dark-v9/tiles/256/{0}/{1}/{2}?access_token={3}";
		}
