...
namespace Fusion.Engine.Graphics.GIS.GlobeMath
{
    ...
    public struct DQuaternion : IEquatable<DQuaternion>, IFormattable
    {
        ...
        /// </summary>
        public static readonly DQuaternion One = new DQuaternion(1.0, 1.0, 1.0, 1.0);

        /// <summary>
        /// The identity <see cref="DQuaternion"/> (0, 0, 0, 1).
        /// </summary>
        public static readonly DQuaternion Identity = new DQuaternion(0.0, 0.0, 0.0, 1.0);
        ...
        public double Angle
        {
            get
            {
                ...
                return (double)(2.0 * Math.Acos(DMathUtil.Clamp(W, -1, 1)));
            }
        }
        ...
        public static void Slerp(ref DQuaternion start, ref DQuaternion end, double amount, out DQuaternion result)
        {
            ...
            if (Math.Abs(dot) > 1.0 - DMathUtil.ZeroTolerance)
            {
                inverse = 1.0 - amount;
