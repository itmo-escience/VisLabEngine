...
namespace Fusion.Engine.Graphics.GIS.GlobeMath
{
    ...
    public struct DMatrix : IEquatable<DMatrix>, IFormattable
    {
        ...
        /// </summary>
        public static readonly DMatrix Identity = new DMatrix { M11 = 1.0, M22 = 1.0, M33 = 1.0, M44 = 1.0 };
        ...
        {
            double yScale = (double)(1.0 / Math.Tan(fov * 0.5));
        ...
        public static void Skew(double angle, ref DVector3 rotationVec, ref DVector3 transVec, out DMatrix DMatrix)
        {
            ...
            double MINIMAL_SKEW_ANGLE = 0.000001;
        ...
        {
            result = Scaling(scaling, scaling, 1.0) * RotationZ(rotation) * Translation((DVector3)translation);
        }
        ...
        {
            result = Scaling(scaling, scaling, 1.0) * Translation((DVector3)(-rotationCenter)) * RotationZ(rotation) *
