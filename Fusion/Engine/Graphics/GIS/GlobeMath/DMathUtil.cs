...
namespace Fusion.Engine.Graphics.GIS.GlobeMath
{
    public static class DMathUtil
    {
        ...
        /// </summary>
        public const double ZeroTolerance = 1e-6; // Value a 8x higher than 1.19209290E-07F   TODO replace for double type 2.2204460492503131E-016
        ...
        /// </summary>
        public const double PiOverTwo = (double)(Math.PI / 2.0);
        ...
        /// <returns><c>true</c> if the specified value is close to zero (0.0); otherwise, <c>false</c>.</returns>
		...
		public static DVector2 RadiansToDegrees(DVector2 radian)
		{
			return new DVector2(RadiansToDegrees(radian.X), RadiansToDegrees(radian.Y));
		}
