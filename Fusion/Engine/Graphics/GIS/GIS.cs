...
namespace Fusion.Engine.Graphics.GIS
{
    ...
    {
		[Config]
		public static float MaxValue { set; get; }
		[Config]
	    ...
	    public struct ConstData
	    {
			...
			[FieldOffset(88)]	public Vector2 Dummy;
	    }
	    ...
	    public  void Draw(GameTime gameTime, StereoEye stereoEye, ICollection<GisLayer> layers)
	    {
			...
			using (new PixEvent("GIS")) {
                ...
                var batches = layers.OrderByDescending(x => x != null ? x.ZOrder : 0);
		...
		{
			Log.Warning("Message: " + message + "member name: " + memberName + "source file path: " + sourceFilePath + "source line number: " + sourceLineNumber);
		}
