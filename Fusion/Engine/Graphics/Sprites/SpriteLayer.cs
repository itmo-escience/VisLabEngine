...
namespace Fusion.Engine.Graphics {
	public class SpriteLayer : DisposableBase {
		...
		public void DrawBeam ( Texture srv, Vector2 p0, Vector2 p1, Color color0, Color color1, float width, float scale=1, float offset=0, int clipRectIndex=0 )
		{
            ...
            PushQuad(srv,
                new SpriteVertex( origin - basisY 			, color0, new Vector2(u0, 0), clipRectIndex),
                new SpriteVertex( origin - basisY + basisX	, color1, new Vector2(u1, 0), clipRectIndex),
                new SpriteVertex( origin + basisY + basisX	, color1, new Vector2(u1, 1), clipRectIndex),
                new SpriteVertex( origin + basisY 			, color0, new Vector2(u0, 1), clipRectIndex) 
				);
		}
