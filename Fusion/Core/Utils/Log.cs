...
namespace Fusion {
	public static class Log {
		...
		/// </summary>
		/// <param name="message"></param>
		public static void WarningCode(string message, [CallerFilePath] string filePath = "", [CallerLineNumber] int lineNumber = 0)
		{
			AddMessage(LogMessageType.Warning, "[" + filePath + " line: " + lineNumber + "]\n" + message);
		}
